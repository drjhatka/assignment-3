...
router.post('/refresh-token', (0, auth_middleware_1.auth)('user', 'admin'), (0, validate_request_1.ValidateRefreshToken)(auth_validation_1.AuthValidation.refreshTokenValidationSchema), auth_controller_1.AuthController.refreshToken);
