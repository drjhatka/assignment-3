...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, auth_utils_1.checkLoginCredentials)(user, payload);
    //all good, now proceed to issuing a jwt token to the user
    return yield (0, auth_utils_1.createJWTToken)({ email: user === null || user === void 0 ? void 0 : user.email, role: user === null || user === void 0 ? void 0 : user.role }, config_1.config.jwt_secret, '1h');
});
exports.AuthService = {
    createUserIntoDB,
    loginUser
